...
@section('content')
    ...
    <div class="content">
        <div class="main">
            <h3 style="padding-left: 20px; padding-top: 20px; ">Tạo Thông báo</h3>
            <div class="form-group form" >
                <form action="{{ route('teacher.announcements.store', $course->id) }}" method="post">
                    @csrf
                    ...
                    <label for="title"><p>Tiêu đề</p></label>
                    @error('title')
